...
class ProfileScreenContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Smooth animation curves like in Kotlin
    final alpha = Curves.easeOutCubic.transform(progress);
    final scale = _lerp(0.92, 1.0, Curves.easeOutCubic.transform(progress));
    final slideY = _lerp(50.0, 0.0, Curves.easeOutCubic.transform(progress));
    ...
    return AnimatedOpacity(
      ...
      child: TweenAnimationBuilder<double>(
        tween: Tween<double>(begin: 0.92, end: scale),
        ...
        builder: (context, animatedScale, child) {
          return Transform.scale(
            scale: animatedScale,
            child: TweenAnimationBuilder<double>(
              tween: Tween<double>(begin: 50.0, end: slideY),
              duration: const Duration(milliseconds: 400),
              curve: Curves.easeOutCubic,
              builder: (context, animatedSlideY, child) {
                return Transform.translate(
                  offset: Offset(0, animatedSlideY),
                  child: Container(
