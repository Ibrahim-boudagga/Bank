...
class BlobContent extends StatelessWidget {
  ...
  static const List<String> _contactNames = ['Farid', 'Shadi', 'Cyrus'];
  static const List<Color> _contactColors = [
    Color(0xFFFF8A65),
    Color(0xFF29B6F6),
    Color(0xFFB9F6CA),
  ];
  static const List<String> _transactionNames = [
    'Annette Black',
    'Cameron Williamson',
    'Jane Cooper',
    'Wade Warren',
  ...
  static const List<String> _transactionInitials = ['A', 'C', 'J', 'W', 'D', 'M'];
  ...
  Widget build(BuildContext context) {
    ...
    final scale = textScaler.scale(1.0).clamp(0.8, 1.2);
    final titleFontSize = (screenWidth * 0.05).clamp(18.0, 20.0) * scale;
    final largeTitleFontSize = (screenWidth * 0.085).clamp(28.0, 34.0) * scale;
    final pillFontSize = (screenWidth * 0.04).clamp(14.0, 16.0) * scale;
    final contactNameFontSize = (screenWidth * 0.03).clamp(10.0, 12.0) * scale;
    final sectionTitleFontSize = (screenWidth * 0.05).clamp(18.0, 20.0) * scale;
    final contactItemFontSize = (screenWidth * 0.04).clamp(14.0, 16.0) * scale;
    final contactSubtitleFontSize = (screenWidth * 0.03).clamp(10.0, 12.0) * scale;
    final buttonFontSize = (screenWidth * 0.042).clamp(15.0, 17.0) * scale;
              ...
              child: CustomScrollView(
                slivers: [
                          ...
                          Expanded(
                            child: Transform.scale(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: _contactNames.length + 1,
                                itemBuilder: (context, index) {
                                  if (index < _contactNames.length) {
                                    return Padding(
                                      padding: EdgeInsets.only(
                                        right: index < _contactNames.length - 1 ? 16 : 0,
                                      ),
                                      child: ContactCircle(
                                        name: _contactNames[index],
                  ...
                  SliverList(
                    ...
                    }, childCount: _transactionNames.length),
                  ),
                  SliverToBoxAdapter(
                    child: Transform.scale(
                      scale: buttonScale,
